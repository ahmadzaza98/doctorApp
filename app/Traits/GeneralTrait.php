...
trait GeneralTrait
{
    ...
    public function transformCollection($contacts){
        return array_map([$this , 'transform_post'] , $contacts->toArray());
    }
    public function transformCollection1($contacts){
        return array_map([$this , 'transform_comment'] , $contacts->toArray());
    }

    public function transform_post($contact){
        return [
            'id' => $contact['id'],
    ...
    public function transform_comment($contact){
        return [
            'id' => $contact['id'],
